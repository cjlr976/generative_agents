...
To set up your environment, you will need to generate a `utils.py` file that contains your Gemini API key and download the necessary packages.

### Step 1. Generate Utils File
In the `reverie/backend_server` folder (where `reverie.py` is located), create a new file titled `utils.py` and copy and paste the content below into the file:
```
# Copy and paste your Gemini API Key
...
debug = True
```
Replace `<Your Gemini API>` with your Gemini API key, and `<name>` with your name.
